    ...
    <section class="min-h-screen flex flex-col items-center justify-center bg-gray-900">
        ...
        <?php
         ...
         <?php
            ...
            <form class="flex flex-col space-y-6 p-6 rounded-b-lg shadow-xl/30 bg-gray-800/80" action="cek_register_users.php" method="post">
                <label for="Username">
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-200 items-center"> Username </span>

                    <input type="Text" placeholder="Masukkan nama kamu" name="Username" required
                ...
                <label for="Email">
                    ...
                    <input type="Email" placeholder="Masukkan Email kamu" name="Email" required
                        class="text-sm placeholder:text-gray-500 placeholder:italic mt-0.5 h-8 w-full px-3 rounded border-gray-300 shadow-sm sm:text-sm dark:border-gray-600 dark:bg-gray-700/75 dark:text-white">
                </label>
                ...
                <label for="Confirm_Password">
                    ...
                    <input placeholder="Samakan Password Kamu" type="Password" name="Confirm_Password" required
                        class="text-sm placeholder:text-gray-500 placeholder:italic mt-0.5 h-8 w-full px-3 rounded border-gray-300 shadow-sm sm:text-sm dark:border-gray-600 dark:bg-gray-700/75 dark:text-white">
                </label>
                ...
                <div class="flex justify-center text-xs gap-1">
                    <div class="text-gray-500">Sudah punya Akun?
                    </div>

                    <a href="./login.php"
                        class="text-sky-600 no-underline hover:underline dark:text-sky-400">Klik disini</a>
                </div>
