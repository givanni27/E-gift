            ...
            <div class="flex flex-1 items-center justify-end md:justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="sm:flex sm:gap-4">
                        <a class="block rounded-md bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-indigo-700 dark:hover:bg-indigo-500"
        ...
        <div class="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-12">
            ...
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl font-bold text-gray-900 sm:text-6xl dark:text-white leading-tight">
                    Halo users, selamat datang
                    <span class="text-indigo-600 block sm:inline"> Di website</span>
                    Belanja Boneka!
                </h1>
                ...
                while ($row = mysqli_fetch_array($sql)):
                    ...
                    <article
                        ...
                        <div class="bg-white p-4 sm:p-6 dark:bg-gray-900">
                            ...
                            <p class="mt-2 line-clamp-3 text-base text-gray-500 dark:text-gray-200 text-center">
